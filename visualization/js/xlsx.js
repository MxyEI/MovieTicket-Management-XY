...
var HTML_ = (function() {
	...
	function make_html_preamble(ws, R, o) {
		var out = [];
		return out.join("") + '<table class="altrowstable" id="alternatecolor">';
		//return out.join("") + '<table align=center border=2 cellspacing=0>';
	}
...
function writeSync(wb, opts) {
	...
	switch(o.bookType || 'xlsb') {
		...
		case 'html': return write_htm_str(wb, o);
